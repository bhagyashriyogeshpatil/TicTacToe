...
- [Features](#features)
  - [Existing Features](#existing-features)
    - [Favicon](#favicon)
    - [Login Screen for Mobile](#login-screen-for-mobile)
    - [Login Screen for Desktop](#login-screen-for-desktop)
    - [User Login Error Message](#user-login-error-message)
    - [Instruction Modal for Mobile](#instruction-modal-for-mobile)
    - [Instruction Modal for Desktop](#instruction-modal-for-desktop)
    - [Game Screen for Mobile](#game-screen-for-mobile)
    - [Game Screen for Desktop](#game-screen-for-desktop)
    - [Winner Message for Mobile](#winner-message-for-mobile)
    - [Winner Message for Desktop](#winner-message-for-desktop)
    - [Footer for Mobile](#footer-for-mobile)
    - [Footer for Desktop](#footer-for-desktop)
...
- [Design](#design)
  - [Wireframe](#wireframe)
    - [Login Screen Wireframe](#login-screen-wireframe)
    - [Instruction Modal Wireframe](#instruction-modal-wireframe)
    - [Game Screen Wireframe](#game-screen-wireframe)
    - [Winner Message Wireframe](#winner-message-wireframe)
...
- [Testing](#testing)
  ...
  - [Lighthouse Report](#lighthouse-report)
    - [Lighthouse Report for Mobile](#lighthouse-report-for-mobile)
    - [Lighthouse Report for Desktop](#lighthouse-report-for-desktop)
